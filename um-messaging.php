...
define( 'um_messaging_requires', '2.8.0' );
	...
	function um_messaging_check_dependencies() {
		if ( ! defined( 'um_path' ) || ! file_exists( um_path  . 'includes/class-dependencies.php' ) ) {
			...
			if ( ! $is_um_active ) {
				 ...
				 *
				 * @param array $settings Сore and extension settings.
				 *
				 * @since 1.0.0
				 * @return array
				 */
				function um_messaging_extend_license_settings( $settings ) {
				...
				add_filter( 'um_settings_structure', 'um_messaging_extend_license_settings' );
